...
# article-A1 directory. W creates canonical/article.html before the review index.
...
# For a current schema-2.12 article package (schema 1.5), verify its package-declared
