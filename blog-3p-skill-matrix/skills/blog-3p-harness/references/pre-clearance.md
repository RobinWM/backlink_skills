...
4. Cross-language method: brand-site pages to inspect, English-only Google Trends seed/candidate set and window, target-region SERP method, English-concept-to-local-variant mapping, and any explicit waiver.
