...
| 内容 | 适合场景 | 核心特点 |
|---|---|---|
| [双线外链挖掘矩阵](双线外链挖掘矩阵/README.zh-CN.md) | 从 Semrush、竞品外链、历史表和公开资源中持续扩充候选，并分别制作批量线与质量线执行表 | 源表压缩、双线筛选、历史去重、批次冻结、免费/付费分表、机械与视觉检查 |
...
├── 双线外链挖掘矩阵/                 # 源表整理、批量线、质量线、去重与制表 Skill 矩阵
│   ├── README.md
│   ├── matrix.yaml
│   └── skills/
